...
<div class="card-header bg-danger text-center text-white lead">
        <h4 class="m-0">Total Deleted Admin</h4>
    </div>
    <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function fetchAllDeletedUsers(){
            $.ajax({
                ...
                method:'post',
                data:{action:'fetchAllDeletedAdminUsers'},
    ...
    $("body").on("click",".restoreAdminUserIcon",function(e){
            e.preventDefault();
            admin_res_id = $(this).attr('id');
            Swal.fire({
             ...
             if (result.value) {
                ...
                url:'assets/php/action.php',
                method:'post',
                data:{admin_res_id: admin_res_id},
                success:function(response){
                    Swal.fire(
                        'Deleted',
