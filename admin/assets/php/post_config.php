...
//   }
  ...
  if (isset($_POST['upload'])) {
    ...
    $folder = '../user-admin/assets/php/imagesuploadedf/';
    //function for saving the uploaded images in a specific folder
    move_uploaded_file($filetmpname, $folder.$image);

  	$sql = "INSERT INTO notice_board_bsc_actu_sci (image,title,posted_by, body,type,message) VALUES ('$image','$title','$posted_by','$body','$type','New Notice Posted !!!')";
