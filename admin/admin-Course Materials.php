...
<!-- <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
   ...
   <div class="col-lg-12">
     <div class="card  border-warning m-2">
	   ...
	   <div class="border-dark"><h4 class="float-right font-weight-bold  navbar-brand border p-2 rounded d p-1" id="popup"> || Add Course Materials</h4></div>
         <h4 class="ml-4 font-wieght-bold">All Course Materials</h4>
       </div>
       <div class="card-body ">
...
<div class="modal bg-dark  fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="m-2  header" id="title-pop">Please Fill the Form to Upload a Course Material</h5> 
...
<!-- 
    ...
    <ul>
        ...
        <li>Bsc. Agriculture with Option in Crop Production Horticulture  </li>
        ...
        <li>Bsc. Environmental Engineering  </li>
    </ul> -->
</div>
               </div>                
