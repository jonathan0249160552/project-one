...
<div class="card-header bg-info text-center text-white lead">
        <h4 class="m-0 font-weight-bold">Total Posts on Notice Board </h4>
    </div>
    <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
         ...
         <div class="form-group">
             <label for="title" class="text-primary font-weight-bold " style="font-size: larger;">Edit Title</label>
                  <input type="text" name="title" id="title" placeholder="Title  " 
                  class="form-control-lg form-control rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="posted_by" class="text-primary font-weight-bold " style="font-size: larger;">Edit Posted By</label>
                <input type="text" name="posted_by" id="posted_by" placeholder="Posted By" 
                  class="form-control-lg form-control rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="type" class="text-primary font-weight-bold " style="font-size: larger;">Select Type</label>
...
<!--                 
              <div  class="form-group ">
                  ...
                  <div class="form-group">
                      <label for="body" class="text-primary font-weight-bold " style="font-size: larger;">Edit Body</label>
...
<!-- display Noticeboard in Details modal  -->
  ...
  <div class="modal fade " id="NoticeboardDetailsModal2">
    <div class="modal-dialog modal-xl card-header modal-dialog-centered " >
        <div class="modal-content">
            <div class="modal-header m-1 p-1 align-self-center">
               <h4 class="modal-title font-weight-bold" id="getType2"></h4>
               <button type="button" class="close" data-dismis="modal"></button> 
            </div>
            <div class="modal-body">
            <div class="card-deck">
            <div class="card align-self-center" id="getImage2"></div>
                <div class="card border-primary">
                    <div class="card-body">
                    <p id="getTitle2"></p>
                    <p id="getBody2"></p>
                   
                    <p id="getPosted_by2"></p>

                    <p id="getCreated_at2"></p>
...
<script type="text/javascript">
 ...
 $("body").on("click",".editNoticeBtn",function(e){
        ...
        $("body").on("click",".deleteBtn",function(e){
            ...
            Swal.fire({
             ...
             if (result.value) {
                ...
                url:'assets/php/action.php',
                method:'post',
                data:{del_id_notice: del_id_notice},
                success:function(response){
                    Swal.fire(
                        'Deleted',
                        'notice deleted successfully',
    ...
    $("body").on("click",".NoticeboardDetailsIcon2", function(e){
            e.preventDefault();
            Noticeboard_details_id = $(this).attr('id');
            $.ajax({
                url:'assets/php/action.php',
                ...
                success:function(response){
                    data = JSON.parse(response);
                    // $("#getImage").text(''+data.image);
                 $("#getType2").text(''+data.type);
                 
               
                 $("#getTitle2").text('Title : '+data.title);
                 $("#getBody2").text('Message : '+data.body);
                 $("#getPosted_by2").text('Posted By : '+data.posted_by);
                 $("#getCreated_at2").text('Posted On : '+data.created_at);
                 
                 if(data.image == ''){
                    $("#getImage2").html('<img src="assets/img/va2.PNG" class=" img-fluid align-self-center" >');
			}
			else{
                $("#getImage2").html('<img src="assets/php/imagesuploadedf/'+data.image+'" class=" img-fluid align-self-center">');

			}
                 if(data.title == ''){
                     
                     $("#getTitle2").html('Title : <span class="text-danger font-weight-bold">Empty</span>');
                 }
                 else{
                    $("#getTitle2").text('Title : '+data.title+'');
                 }
                 ...
                 if(data.type == ''){
                     ...
                     $("#getType2").html('<span class="text-danger font-weight-bold">Empty</span>');
                 }
                 else{
                    $("#getType2").text(''+data.type+'');
                 }
                 ...
                 if(data.body == ''){
                     ...
                     $("#getBody2").html('Message : <span class="text-danger font-weight-bold">Empty</span>');
                 }
                 else{
                    $("#getBody2").text('Message : '+data.body+'');
                 }
                 ...
                 if(data.posted_by == ''){
                     ...
                     $("#getPosted_by2").html('Posted By : <span class="text-danger font-weight-bold">Empty</span>');
                 }
                 else{
                    $("#getPosted_by2").text('Posted By : '+data.posted_by+'');
                 }
