...
<div class="row ">
    ...
    <div class="card-deck mt-3 text-light text-center font-weight-bold">
            <div class="card bg-primary">
                <div class="card-header font-weight-bold text-white"> Total Users</div>
            
            <div class="card-body">
            <h1 class="display-4 text-white">
            <?=
            $count->totalcount($clevel,$cprogram);
            ?>
            </h1>
            </div>
            </div>
    ...
    <div id="1" class="col-lg-12">
        <div class="card-deck mt-3 text-light text-center font-weight-bold">
            ...
            <div class="card bg-info">
                <div class="card-header font-weight-bold text-white">Total Feedback</div>
                    <div class="card-body">
                        <h1 class="display-4 text-white">
                        <?= $count->totalcount($clevel,$cprogram); ?>  
                        </h1>
    ...
    <div class="col-lg-12 justify-content-center">
        <div class="card-deck my-3">
            <div class="card border-success">
                    ...
                    <div class="card-header bg-success font-weight-bold text-center text-white lead">
