  ...
  <body class="bg-info">
    ...
    <div class="container h-100">
      ...
      <div class="row h-100 align-items-center justify-content-center" id="login-box">
        <div class="col-lg-10 my-auto bg-dark myShadow">
          <div class="row">
            <div class="col-lg-7 bg-white p-4">
              ...
              <div class="input-group input-group-lg form-group">
                ...
                <div class="input-group input-group-lg form-group">
                  ...
                  <input type="submit" id="login-btn" value="Sign In" class=" p-2 lead text-white font-weight-bolder rounded btn-primary btn-block "/>
              </form>
            </div>
